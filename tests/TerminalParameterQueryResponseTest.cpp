...
protected:
    void SetUp() override
    {
        ...
        m_body = new TerminalParameterQueryResponse(123, params);
        m_rawData = {0x0,  0x7b, 0xa,  0x0,  0x0,  0x0,  0x1,  0x4,  0x0,  0x0,  0x0,  0x3c, 0x0,  0x0,  0x0,
                     ...
                     0x0,  0x0,  0x1e, 0x0,  0x0,  0x0,  0x20, 0x4,  0x0,  0x0,  0x0,  0x0,  0x0,  0x0,  0x0,
                     0x91, 0x1,  0x5,  0x0,  0x0,  0x0,  0x13, 0xc,  0x31, 0x39, 0x32, 0x2e, 0x31, 0x36, 0x38,
                     0x2e, 0x38, 0x2e, 0x37, 0x38, 0x0,  0x0,  0x0,  0x11, 0x7,  0x4a, 0x69, 0x6d, 0x69, 0x49,
                     0x4f, 0x54, 0x0,  0x0,  0x0,  0x12, 0x7,  0x4a, 0x69, 0x6d, 0x69, 0x49, 0x4f, 0x54};
        m_object = nlohmann::json::object(
            {{"seq", 123},
             {"length", 10},
             {"params",
              nlohmann::json::array({{{"id", HeartBeatInterval}, {"value", 60}},
...
TEST_F(TerminalParameterQueryResponseTest, TestFromJsom)
{
    TestFromJson();
}

TEST_F(TerminalParameterQueryResponseTest, TestToJson)
{
    TestToJson();
}
