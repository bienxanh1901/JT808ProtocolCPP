...
protected:
    ...
    void SetUp() override
    {
        m_body = new ImmediateCameraCaptureCommand(123, 3, 30, ImmediateCameraCaptureCommand::LocalStorage,
                                                   ImmediateCameraCaptureCommand::Resolution1024x768, 10, 120, 127, 127,
                                                   120);
